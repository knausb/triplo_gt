...
//    cout << "pos0=" << pos[0] << "\n";
  ...
  /* Bi-allelic pentaploid loci */
  /* 4/5,1/5 AAAAC, AAAAG, AAAAT, CCCCA, CCCCG, CCCCT, GGGGA, GGGGC, GGGGT, TTTTA, TTTTC, TTTTG */
  /* 3/5,2/5 AAACC, AAAGG, AAATT, CCCAA, AAAGG, CCCTT, GGGAA, GGGCC, GGGTT, TTTAA, TTTCC, TTTGG */
  /* 51-74 */

  /* Tri-allelic pentaploid loci */
  /* 3/5,1/5,1/5 AAACG, AAACT, AAAGT, CCCAG, CCCAT, CCCGT, GGGAC, GGGAT, GGGCT, TTTAC, TTTAG, TTTCG */
  /* 2/5,2/5,1/5 AACCG, AACCT, AAGGC, AAGGT, AATTC, AATTG, */
  /*             CCGGA, CCGGT, GGTTA, GGTTC  */
  /* 75-96 */

  /* Tetra-allelic pentaploid loci */
  /* 2/5,1/5,1/5,1/5 AACGT, CCAGT, GGACT, TTACG */
  /* 97-100 */

  /* Bi-allelic hexaploid loci */
  /* 5/6,1/6 AAAAAC, AAAAAG, AAAAAT, CCCCCA, CCCCCG, CCCCCT, GGGGGA, GGGGGC, GGGGGT, TTTTTA, TTTTTC, TTTTTG*/


  /* Tri-allelic hexaploid loci */
  /* 4/6,1/6,1/6 AAAACG, AAAACT, AAAAGT, CCCCAG, CCCCAT, CCCCGT, GGGGAC, GGGGAT, GGGGCT */
  /* 3/6,2/6,1/6 AAACCG, AAACCT, AAAGGC, AAAGGT, AAATTC, AAATTG,*/


  /* Tetra-allelic hexaploid loci */
  /* 3/6,1/6,1/6,1/6*/
  /* 2/6,2/6,1/6,1/6*/
